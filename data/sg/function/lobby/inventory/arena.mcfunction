...
item replace entity @s hotbar.1 with wooden_sword[custom_name={"translate":"sg.lobby.arena.sword.name","color":"yellow","bold":false,"italic":false},unbreakable={},tooltip_display={hidden_components:["unbreakable"]}]
